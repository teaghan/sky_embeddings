...
cp /project/rrg-kyi/astro/hsc/HSC_dwarf_galaxies_GRIZY_64_new.h5 $SLURM_TMPDIR
cp /project/rrg-kyi/astro/hsc/HSC_unkown_GRIZY_64_new.h5 $SLURM_TMPDIR
cp /project/rrg-kyi/astro/hsc/HSC_strong_lens_candidates_GRIZY_64.h5 $SLURM_TMPDIR
