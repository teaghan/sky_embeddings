...
srun python /home/heesters/projects/def-sfabbro/heesters/github/sky_embeddings/pretrain_mim.py jepa_1GPU --dist_backend nccl --init_method tcp://$MASTER_ADDR:$MASTER_PORT --world_size $SLURM_NTASKS  --batch_size 64 --verbose_iters 5000 --cp_time 10.00 --cp_freq 2500 -dd $SLURM_TMPDIR/