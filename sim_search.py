...
from utils.dataloaders import build_dataloader
from utils.plotting_fns import display_images, normalize_images, h5_snr
from utils.eval_fns import mae_latent
from utils.similarity import (mae_simsearch, compute_similarity, plot_dual_histogram)

def parseArguments():
    # Create argument parser
    parser = argparse.ArgumentParser('Similarity Search', add_help=False)
    ...
    parser.add_argument("-dd", "--data_dir", 
                        help="Data directory if different from sky_embeddings/data/", 
