...
target_img = np.einsum('ijkl->iljk', target_images[:,[1,2,4],:,:].data.cpu().numpy())
...
display_images(normalize_images(np.einsum('ijkl->iljk', test_images[:n_plot,[1,2,4],:,:].data.cpu().numpy())), 
