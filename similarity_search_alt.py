...
display_images(normalize_images(np.einsum('ijk->jki', target_images[:,[1,2,4],:,:].data.cpu().numpy())), 
...
display_images(normalize_images(np.einsum('ijk->jki', test_images[:n_plot,[1,2,4],:,:].data.cpu().numpy())), 
